<li class="productItem">
	...
	<% else %>
		<a href="$Link" title="Click here to read more on &quot;{$Title}&quot;"><img src="themes/higherground_ecommerce/images/productPlaceHolderThumbnail.gif" alt="Sorry, no product image for &quot;{$Title}&quot;" /></a>
	<% end_if %>
			...
			<% if AllowPurchase %>
				<% if IsInCart %>
					<div class="quantityBox">
						<span>Quantity:</span>
						<a class="ajaxQuantityLink" href="{$Link}remove/" title="Remove one of &quot;{$Title}&quot; from your cart" style="color:red;">
							(-)
						</a>	
						$AjaxQuantityField
						<a class="ajaxQuantityLink" href="{$Link}add/" title="Add one more of &quot;{$Title}&quot; to your cart" style="color:green;">
							(+)
						</a>
